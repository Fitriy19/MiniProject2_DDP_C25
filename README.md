...
#### d. Delete
Saat user memilih pilihan 4, program akan menampilkan pemberitahuan bahwa user memilih hapus data pelanggan dan langsung menampilkan tabel data pelanggan. kemudian program meminta input nama pelanggan yg ingin dihapus. Jika input berhasil maka program akan langsung menampilkan tabel data pelanggan terbaru.
